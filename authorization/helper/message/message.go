...
var FailedLogin = Message{Code: 0000, Message: "Invalid email or password"}
var MemberNotLogin = Message{Code: 0000, Message: "Member is not allowed to log into the system"}
